...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Tanishka\\OneDrive\\Documents\\2. Courses\\PSY310\\Experiments\\T1 Adaptive Satircase\\Adaptive Staircase Procedure_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisStaircase in staircase:
        ...
        if isinstance(staircase, data.TrialHandler2) and thisStaircase.thisN != staircase.thisTrial.thisN:
